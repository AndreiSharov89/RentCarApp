...
public class MainActivity extends AppCompatActivity {
    ...
    private void addRandomCustomers() {
        String[] names = {
                "Иванов Иван Иванович", "Смирнов Алексей Алексеевич", "Кузнецов Дмитрий Иванович",
                "Попов Андрей Алексеевич", "Лебедев Михаил Сергеевич", "Морозов Александр Сергеевич",
                "Новиков Сергей Вячеславовчи", "Киселёв Владимир Михайлович", "Соколов Павел Алексеевич",
                "Михайлов Николай Иванович", "Петров Юрий Иванович", "Фёдоров Олег Алексеевич"
        };
